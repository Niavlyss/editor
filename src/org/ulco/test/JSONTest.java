...
public class JSONTest extends TestCase {
    ...
    public void testParseGroup() throws Exception {
        ...
        assertTrue(JSON.parseGroups(json) instanceof Group);
        assertEquals(JSON.parseGroups(json).toString(), "group[[square[point[0.0,0.0],5.0], circle[point[5.0,5.0],4.0]],[]]");
    }
    ...
    public void testParseGroup2() throws Exception {
        ...
        assertTrue(JSON.parseGroups(json) instanceof Group);
        assertEquals(JSON.parseGroups(json).toString(), "group[[rectangle[point[-6.0,10.0],5.2,9.0]],[group[[square[point[0.0,0.0],5.0], circle[point[5.0,5.0],4.0]],[]]]]");
    }
